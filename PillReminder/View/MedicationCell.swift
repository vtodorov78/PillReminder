...
class MedicationCell: UITableViewCell {
    ...
    func configureViewComponents() {
       ...
       addSubview(stack1)
        ...
        stack1.spacing = 10
        stack1.anchor(top: titleLabel.bottomAnchor, left: leftAnchor, bottom: nil, right: nil, paddingTop: 8, paddingLeft: 20, paddingBottom: 0, paddingRight: 0, width: 0, height: self.frame.height/2)
        
        addSubview(checkmarkButton)
        checkmarkButton.anchor(top: topAnchor, left: nil, bottom: bottomAnchor, right: rightAnchor, paddingTop: 15, paddingLeft: 15, paddingBottom: 15, paddingRight: 25, width: self.frame.width/8, height: self.frame.width/8)
